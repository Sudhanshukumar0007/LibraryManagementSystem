...
New → Web Service → Connect GitHub → Select library-management-backend
...
⚡ Once deployed, your API will run like:

```

[https://library-management-backend.onrender.com/api/books](https://library-management-backend.onrender.com/api/books)

```

Then we can **test the live API and take screenshots for your report**.
```
